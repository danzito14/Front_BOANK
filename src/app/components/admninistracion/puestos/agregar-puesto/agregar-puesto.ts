...
@Component({
  ...
  templateUrl: './agregar-puesto.html',
  styleUrl: './agregar-puesto.css',
})
export class AgregarPuesto implements OnInit, OnDestroy {
  ...
  private guardarEmpleado(puesto: Partial<Puesto>): void {
    ...
    this.empleadosService.createPuesto(puesto)
